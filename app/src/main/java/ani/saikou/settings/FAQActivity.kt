...
class FAQActivity : AppCompatActivity() {
    ...
    private val faqs = listOf(
        ...
        Triple(R.drawable.ic_round_dns_24,"Is Saikou available for PC?","Currently no. There isn't any estimation when it will be available. But you can download any android emulator and run saikou on it. For Windows 11 users, they can use the Windows Subsystem for Android(aka WSA) to run Saikou in Windows."),
        ...
        Triple(R.drawable.ic_round_help_24,"How to fix sources selecting a completely wrong title?","If you app selects the wrong title, then you can correct it by pressing on \"Wrong Title?\" above the layouts and selecting the correct title"),
