...
class FAQActivity : AppCompatActivity() {
    ...
    private val faqs = listOf(
        ...
        Triple(R.drawable.ic_baseline_screen_lock_portrait_24,"Is Saikou available for IOS?","Saikou for iOS is now under development with the name \"SaikouS\". You can download the builds uploaded by the respective developer from our [discord server](https://discord.gg/TN5Cm94nXU)\n\n[Press here if you want to check out the GitHub Repository](https://github.com/5H4D0WILA/SaikouS)"),
