...
open class Tenshi : AnimeParser() {
    ...
    override suspend fun loadVideoServers(episodeUrl: String): List<VideoServer> {
        ...
        val htmlResponse = httpClient.get(episodeUrl, mapOf(cookieHeader)).document
        htmlResponse.select("ul.dropdown-menu > li > a.dropdown-item").forEach {
            ...
            val headers = mapOf(cookieHeader, "referer" to episodeUrl)
