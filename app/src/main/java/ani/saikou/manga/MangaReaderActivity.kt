        ...
        if(a!=null) {
            ...
            model.getMangaChapMedia().observe(this) {
                if (it != null) {
                    ...
                    val trans = media.manga!!.chapters!![media.manga!!.selectedChapter]?.transformation
                    if (chapImages != null) {
                        binding.mangaReaderRecyclerView.adapter = ImageAdapter(chapImages, headers,trans)
